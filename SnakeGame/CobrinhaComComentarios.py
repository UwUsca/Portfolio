...
class Snake:
    def __init__(self, parent_screen, length):
        self.parent_screen = parent_screen  #Mesma coisa do Surface soq em Snake
        self.block = pygame.image.load("resources/block.jpg").convert() #Upa a imagem
        self.block = pygame.transform.scale(self.block, (50, 50))   #Muda o tamanho da imagem
        self.background = pygame.image.load("resources/fundo.png")

        self.length = length
        self.x = [150]*length    #Pos X inicial
        self.y = [200]*length    #Pox Y inicial
    ...
    def draw(self):
        #self.parent_screen.fill((43, 43, 43)) #Pra não deixar rastro

        self.parent_screen.blit(self.background, (0, 0))
        for i in range(self.length):
            self.parent_screen.blit(self.block, (self.x[i], self.y[i]))   #Coloca o bloco no mundo
...
class Game:
    def __init__(self):     #Constructor
        ...
        self.surface = pygame.display.set_mode((1000, 800))  # Ajusta o tamanho da janela
        #self.surface.fill((43, 43, 43))  # Define a cor do fundo
        pygame.mixer.init()
        #pygame.mixer.music.pause()
        self.play_bg_music("menumusic")
        self.background = pygame.image.load("resources/fundo.png")
        self.surface.blit(self.background,(0,0))
        self.snake = Snake(self.surface, 1)    #Cria um objeto
        self.snake.draw() #Coloca a cobrinha
        self.apple = Apple(self.surface)
        self.apple.draw() #Coloca a maçã

    def is_collision(self, x1, y1, x2, y2): #Colisão com outro bloco
    ...
    def play(self):
        ...
        if self.is_collision(self.snake.x[0],self.snake.y[0],self.apple.x,self.apple.y):    #Se a cabeça da cobra encostar em qualquer lado da maça
    ...
    def show_game_over(self):
        ...
        self.surface.blit(self.gameover, (0, 0))
